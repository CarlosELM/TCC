        ...
        <div class="row">
            <div class="jumbotron p-3 mb-3" style="display: flex;justify-content: center;width: 28%;border-radius: 50px;margin: 0 auto;">
                <div class="user-info">
                    ...
                    <form action="partials/_manageProfile.php" method="POST">
                        <small>Remover Imagem: </small><button type="submit" class="btn btn-primary" name="removeProfilePic" style="font-size: 12px;padding: 3px 8px;border-radius: 9px; background-color:red;">Remover</button>
                    </form>
                    ...
                    <ul class="meta list list-unstyled" style="text-align:center;">
                        ...
                        <li class="my-2"><a href="partials/_logout.php"><button class="btn btn-secondary" style="font-size: 15px;padding: 3px 8px;">Sair</button></a></li>
                    </ul>
                </div>
            </div>
            <div class="content-panel mb-3" style="display: flex;justify-content: center;">
                <div class="border p-3" style="border: 2px solid rgba(0, 0, 0, 0.1);border-radius: 1.1rem;background-color: aliceblue;">
                    <h2 class="title text-center">Perfil<span class="pro-label label label-warning"> (<?php echo $userType ?>)</span></h2>
                    ...
                    <form action="partials/_manageProfile.php" method="post">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control" id="firstName" name="firstName" placeholder="Nome" required value="<?php echo $firstName ?>">
                        </div>
                        <div class="form-group col-md-6">
                            <b><label for="lastName">Sobrenome:</label></b>
                            <input type="text" class="form-control" id="lastName" name="lastName" placeholder="Sobrenome" required value="<?php echo $lastName ?>">
                        </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-row">
                            <div class="form-group  col-md-6">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="tel" class="form-control" id="phone" name="phone" placeholder="Digite seu Número de Telefone" required pattern="[0-9]{11}" maxlength="11" value="<?php echo $phone ?>">
                                </div>
                            </div>
                            <div class="form-group  col-md-6">
                                <b><label for="password">Senha:</label></b>    
                                <input class="form-control" id="password" name="password" placeholder="Inserir Senha" type="password" required minlength="4" maxlength="21" data-toggle="password">
                            </div>
                        </div>
                        <button type="submit" name="updateProfileDetail" class="btn btn-primary">Atualizar</button>
                    </form>
                </div>
            </div>
        </div>
