...
echo '<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item dropdown">
            ...
            while($row = mysqli_fetch_assoc($result)){
              echo '<a class="dropdown-item" href="viewprodutoList.php?catid=' .$row['categorieId']. '">' .$row['categorieName']. '</a>';
            }
            echo '</div>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="viewOrder.php">Seus Pedido</a>
          </li>
          <li class="nav-item">
        ...
        echo '<a href="viewCart.php"><button type="button" class="btn btn-secondary mx-2" title="MyCart">
          ...
          <i class="bi bi-cart">Carrinho (' .$count. ')</i>
        </button></a>';
        ...
        if($loggedin){
          ...
          echo '
          <button type="button" class="btn btn-success mx-2"  data-toggle="modal" data-target="#loginModal">Entrar</button>
          <button type="button" class="btn btn-success mx-2"  data-toggle="modal" data-target="#signupModal">Criar Conta</button>';
        }
  ...
  echo '</div>
    ...
    if(isset($_GET['signupsuccess']) && $_GET['signupsuccess']=="true") {
      echo '<div class="alert alert-success alert-dismissible fade show" role="alert">
              <strong>Registro Concluido!</strong> Agora você pode entrar.
