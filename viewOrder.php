...
<body>
    ...
    <?php 
        ...
        <div class="alert alert-info my-3">
            <font style="font-size:22px"><center>Antes de ver seus pedidos, você tem que fazer seu<strong><a class="alert-link" data-toggle="modal" data-target="#loginModal"> Login</a></strong></center></font>
        </div></div>';
    }
    ?>
