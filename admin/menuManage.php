			...
			<form action="partials/_menuManage.php" method="post" enctype="multipart/form-data">
				<div class="card mb-3">
					...
					<div class="card-footer">
						<div class="row">
							<div class="mx-auto">
								<button type="submit" name="createItem" class="btn btn-sm btn-primary"> Criar </button>
							</div>
						</div>
					</div>
				</div>
					...
					<div class="card-body">
						<table class="table table-bordered table-hover mb-0">
							<thead style="background-color: rgb(111 202 203);">
								<tr>
									<th class="text-center" style="width:7%;">ID Categoria</th>
                            ...
                            <?php
                                ...
                                while($row = mysqli_fetch_assoc($result)){
                                    ...
                                    echo '<tr>
                                            ...
                                            <td>
                                                <img src="/tcc/img/pizza-'.$pizzaId. '.jpg" alt="image for this item" width="150px" height="150px">
                                            </td>
                                            <td>
                                                <p>Nome: <b>' .$pizzaName. '</b></p>
                                                <p>Descrição : <b class="truncate">' .$pizzaDesc. '</b></p>
                                                <p>Preço: <b>R$' .$pizzaPrice. '</b></p>
                                            </td>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header" style="background-color: rgb(111 202 203);">
        <h5 class="modal-title" id="updateItem<?php echo $pizzaId; ?>">ID do Produto <?php echo $pizzaId; ?></h5>
	  	...
	  	<form action="partials/_menuManage.php" method="post" enctype="multipart/form-data">
		    <div class="text-left my-2 row" style="border-bottom: 2px solid #dee2e6;">
		   		<div class="form-group col-md-8">
					...
					<button type="submit" class="btn btn-success my-1" name="updateItemPhoto">Atualizar Imagem</button>
				</div>
				<div class="form-group col-md-4">
					<img src="/tcc/img/pizza-<?php echo $pizzaId; ?>.jpg" id="itemPhoto" name="itemPhoto" alt="item image" width="100" height="100">
				</div>
			</div>
		</form>
		<form action="partials/_menuManage.php" method="post">
            ...
            <input type="hidden" id="pizzaId" name="pizzaId" value="<?php echo $pizzaId; ?>">
            <button type="submit" class="btn btn-success" name="updateItem">Atualizar</button>
        </form>
      </div>
    </div>
  </div>
