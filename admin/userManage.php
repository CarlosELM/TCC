      ...
      <div class="modal-body">
        <form action="partials/_userManage.php" method="post">
              ...
              <div class="form-group row my-0">
                    ...
                    <div class="form-group col-md-6 my-0">
                        <b><label for="userType">Tipo de Usuário:</label></b>
      ...
      <div class="modal-header" style="background-color: #EEAD2D;">
        ...
        <div class="modal-body">
            ...
            <div class="text-left my-2 row" style="border-bottom: 2px solid #dee2e6;">
                <div class="form-group col-md-8">
                    <form action="partials/_userManage.php" method="post" enctype="multipart/form-data">
                        ...
                        <button type="submit" class="btn btn-success mt-3" name="updateProfilePhoto">Atualizar Imagem</button>
                    </form>         
                </div>
                <div class="form-group col-md-4">
                    <img src="/tcc/img/person-<?php echo $Id; ?>.jpg" alt="Profile Photo" width="100" height="100" onError="this.src ='/tcc/img/profilePic.jpg'">
                    <form action="partials/_userManage.php" method="post">
                        <input type="hidden" id="userId" name="userId" value="<?php echo $Id; ?>">
                        <button type="submit" class="btn btn-success mt-2" name="removeProfilePhoto">Remover Imagem</button>
                    </form>
                </div>
            </div>
            ...
            <form action="partials/_userManage.php" method="post">
                ...
                <input type="hidden" id="userId" name="userId" value="<?php echo $Id; ?>">
                <button type="submit" name="editUser" class="btn btn-success">Atualizar</button>
            </form>
        </div>
    </div>
  </div>
