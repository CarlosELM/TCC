    ...
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header" style="background-color: #EEAD2D;">
                <h5 class="modal-title" id="orderItem<?php echo $orderid; ?>">Produtos do Pedido (<b>ID do Pedido: <?php echo $orderid; ?></b>)</h5>
                                ...
                                <?php
                                    ...
                                    while($myrow = mysqli_fetch_assoc($myresult)){
                                        ...
                                        echo '<tr>
                                                <th scope="row">
                                                    <div class="p-2">
                                                    <img src="/tcc/img/produto-'.$produtoId. '.jpg" alt="" width="70" class="img-fluid rounded shadow-sm">
                                                    <div class="ml-3 d-inline-block align-middle">
                                                        <h5 class="mb-0"> '.$produtoName. '</h5><span class="text-muted font-weight-normal font-italic d-block">Rs. ' .$produtoPrice. '/-</span>
                                                    </div>
                                                    </div>
                                                </th>
