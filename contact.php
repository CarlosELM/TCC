  ...
  <?php include 'partials/_nav.php';?>
                ...
                <div class="row">
                  <div class="col-lg-8">
                    <div class="contact-box p-4">
                      <div class="row">
                        <div class="col-lg-8">
                          <h4 class="title">Entre em contato com a gente</h4>
                        </div>
                        <?php if($loggedin){ ?>
                          <div class="col-lg-4">
                        ...
                        <div class="row">
                          <div class="col-lg-6">
                            <div class="form-group mt-3">
                                ...
                                <input type="email" class="form-control" id="email" name="email" placeholder="Digite seu Email" required value="">
                            </div>
                          </div>
                          <div class="col-lg-6">
                            <div class="form-group mt-3">
                          ...
                          <div class="col-lg-6">
                            <div class="form-group mt-3">
                              <b><label for="orderId">ID do Pedido:</label></b>
                              <input class="form-control" type="text" id="orderId" name="orderId" placeholder="Número do seu Pedido" value="0">
                              <small id="orderIdHelp" class="form-text text-muted">Se seu problema não é relacionado ao pedido, digite 0.</small>
                            </div>
                          </div>
                          <div class="col-lg-6">
                            <div class="form-group mt-3">
                              <b><label for="password">Senha:</label></b>
                              <input class="form-control" id="password" name="password" type="password" placeholder="Digite sua senha" required data-toggle="password">
                            </div>
                          </div>
                          <div class="col-lg-12">
                            <div class="form-group  mt-3">
                                <textarea class="form-control" id="message" name="message" rows="2" required minlength="6" placeholder="Como podemos ajudar?"></textarea>
                            </div>
                          </div>
                          <?php if($loggedin){ ?>
                            <div class="col-lg-12">
                              ...
                              <button type="button" class="btn btn-danger-gradiant mt-3 mb-3 text-white border-0 py-2 px-3 mx-2" data-toggle="modal" data-target="#history"><span> Histórico de Mensagens <i class="ti-arrow-right"></i></span></button>
                            </div>
                          <?php }else { ?>
                            <div class="col-lg-12">
                              <button type="submit" class="btn btn-danger-gradiant mt-3 text-white border-0 py-2 px-3" disabled><span> Enviar <i class="ti-arrow-right"></i></span></button>
                              <small class="form-text text-muted">Entre em sua conta para entrar em contato.</small>
                            </div>
                          <?php } ?>
                        </div>
                      </form>
        ...
        <div class="modal-dialog modal-lg" role="document">
          <div class="modal-content">
            <div class="modal-header" style="background-color: rgb(187 188 189);">
              <h5 class="modal-title" id="adminReply">Resposta da Administração</h5>
            ...
            <div class="modal-body" id="messagebd">
              <table class="table-striped table-bordered col-md-12 text-center">
                ...
                <?php 
                    ...
                    if($count==0) {
                      ?><script> document.getElementById("messagebd").innerHTML = '<div class="my-1">Você ainda não recebeu nenhuma resposta.</div>';</script> <?php
                    }
                ?>
                </tbody>
		          </table>
      ...
      <div class="modal fade" id="history" tabindex="-1" role="dialog" aria-labelledby="history" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
          <div class="modal-content">
            <div class="modal-header" style="background-color: rgb(187 188 189);">
              <h5 class="modal-title" id="history">Suas Mensagens</h5>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
            <div class="modal-body" id="bd">
              <table class="table-striped table-bordered col-md-12 text-center">
                ...
                <?php 
                    ...
                    if($count==0) {
                      ?><script> document.getElementById("bd").innerHTML = '<div class="my-1">Você ainda não entrou em contato.</div>';</script> <?php
                    }    
                ?>
                </tbody>
		          </table>
